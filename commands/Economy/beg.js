...
//             const embed = new MessageEmbed()
//                 .setAuthor(`${user.user.username} Begged`, user.user.displayAvatarURL({
//                     dynamic: true
//                 }))
//                 .setTimestamp()
//                 .setColor('RANDOM')
//                 .setDescription(`Already Begged, Beg Again In **${timeleft.seconds} Seconds** Default CoolDown Is **1 Minutes**`)
