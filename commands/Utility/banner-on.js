...
//   aliases : ['awc', 'setwelcome'],
  ...
  run : async(client, message, args, prefix) => {
    ...
    if (!args[0]){
      ...
      .addField(`Reason:`, `Bot banner img not specified`, false)
      .addField(`Usage:`, `${prefix}banner-on [image link]`, false)
      .setTimestamp()
